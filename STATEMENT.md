...
**The one thing you're trusting.** Because votes go by dollars and only the organizer can propose where the money goes, one situation lets the organizer steer the funds: if the organizer themselves put in more money than everyone else combined. So what you're trusting is that the named, public organizer won't out-deposit the whole pool to redirect it. Short of that, no one — not the organizer, not any depositor, not a stranger — can move a cent anywhere except back to the people who put it in. And in the worst imaginable failure, the outcome is: everyone gets refunded. (One more honest note: someone with deep pockets could *delay* the build by depositing enough to dilute a vote, forcing everyone to wait for the six-month refund — an annoyance, never a theft.)
